...
\midrule
268 anomalies = 67.8\% du cout correctif total & Revue systematique des ordres $>$10\,000 EUR & $\sim$6\,M EUR d'economies (reduction 50\%) & Detection anomalies (IF+SVM) \\
\addlinespace
81 equipements a 3+ pannes = 22.3\% du cout & Analyse causes racines, remplacement si cout cumule $>$ cout remplacement & $\sim$1.2\,M EUR & Analyse recurrence \\
\addlinespace
...
\addlinespace
49\% ruptures stock, 7.7\,M EUR affectes & Stock securite sur 144 articles Pareto, revoir seuils reappro & Reduction ruptures 49\%$\rightarrow$25\% & Pareto + ruptures \\
\addlinespace
